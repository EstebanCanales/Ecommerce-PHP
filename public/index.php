        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
                <div class="flex justify-start lg:w-0 lg:flex-1">
                    <a href="index.php" class="text-xl font-bold text-gray-800"><img src="../images/Silk Road Logo.png" class="w-auto h-12"></a>
                </div>
                ...
                <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <a href="logout.php" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-600 hover:bg-green-700">
                            Cerrar sesión
                        </a>
                    <?php else: ?>
                        ...
                        <a href="register.php" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-600 hover:bg-green-700">
                            Registrarse
                        </a>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <form method="post" action="cart.php">
                                ...
                                <button type="submit" name="add_to_cart" class="mt-4 w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 transition duration-300">
                                    Añadir al carrito
                                </button>
                            </form>
                        </div>
